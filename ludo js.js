...
$db = mysqli_connect("localhost","root","","ludo");
...
// -----------index.php-----------
<!-- 
Developed By ismail,shafi,ajaz at (Compiler)
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<span class="visually-hidden">Loading...</span>
       ...
       <hr>
<div class="super-center">Developed By Ismail,Shafi,Ajaz at (COMPILER)</div> 
...
.dice {
  ...
  .show-2 {
    ...
    {/* ---------htdocs folder backend----xaamp appp------ */}
    {/* folder name assests--
    folder1 js folder 
    -files-
    autorun
